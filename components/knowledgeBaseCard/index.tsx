...
export default function KnowledgeBaseCard({
  ...
  return (
    <div
      className="group mx-auto w-full max-w-sm transform cursor-pointer rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all duration-300 ease-in-out hover:shadow-md sm:w-full sm:max-w-none sm:p-6 dark:border-gray-700 dark:bg-gray-900"
      onClick={onDetail}
      role="button"
      tabIndex={0}
      onKeyDown={(e) => {
