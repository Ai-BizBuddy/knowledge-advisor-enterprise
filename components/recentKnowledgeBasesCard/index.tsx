...
export default function RecentKnowledgeBasesCard({ items }: IRecentKnowledgeBasesCardProps) {
    return (
            ...
            <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                {items.map((item, index) => (
                    <li key={index} className="py-4 flex gap-3 items-start">
                        <svg className="w-6 h-6 text-green-500 mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
