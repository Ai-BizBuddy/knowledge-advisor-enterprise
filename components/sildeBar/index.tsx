...
export default function SlideBar({ children, onNavigate, handleLogout }: SlideBarProps) {
    const {
        navigationItems,
        isUserMenuOpen,
        handleMenuItemClick,
    ...
    return (
        <>
            ...
            <aside
                id="logo-sidebar"
                className="fixed top-0 left-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-20 transition-transform sm:translate-x-0 dark:border-gray-700 dark:bg-gray-900"
                aria-label="Sidebar"
            >
            ...
            {/* Main Content */}
            <div className="p-4 sm:ml-64 dark:bg-gray-800 bg-gray-200 h-full">
