...
export default function ChatHistoryCard({
    ...
    return (
        <div className="cursor-pointer rounded-lg bg-white dark:bg-gray-900/95 p-4 text-white shadow transition-all hover:shadow-lg">
            ...
            {tags.map((tag, i) => (
                <span
                    key={i}
                    className="mr-2 mb-1 inline-block rounded-md dark:bg-gray-800 bg-gray-200 px-2 py-1 text-xs text-gray-900 dark:text-gray-300"
                >
                    {tag}
                </span>
            ))}
