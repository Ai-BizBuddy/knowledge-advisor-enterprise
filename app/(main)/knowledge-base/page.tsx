"use client"
import { CreateKnowledgeBaseModal, KnowledgeBaseCard, Tabs } from "@/components";
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-6 gap-4 sm:gap-0">
                <div>
                    <h1 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white">Knowledge Base</h1>
                    {/* subtitle */}
                    <p className="text-xs sm:text-base text-gray-500 dark:text-gray-400">Manage your enterprise knowledge repositories</p>
                </div>
                {/* New */}
            ...
            <div className="shadow flex bg-gray-100 dark:bg-gray-900 border-gray-700/50 rounded-2xl p-4 mb-6">
                <Tabs currentTab={activeTab} tabList={tabList} onTabChange={(value) => hadleTabChange(value)} />
            </div>

            <KnowledgeBaseCard title="KB Not Found" detail="KB Not Found" updated="KB Not Found" onDelete={() => { }} onDetail={() => { }} />
