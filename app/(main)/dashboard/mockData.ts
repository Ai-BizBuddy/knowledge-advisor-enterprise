 ...
 */
export const getRecentKnowledgeBasesData =
 ...
 */
export const getRecommendedKnowledgeBasesData =
  (): RecommendedKnowledgeBasesProps => ({
    items: [
      {
        title: 'How to Handle Sensitive Data',
        summary:
          'Based on your recent documents, this topic may be useful to reinforce security practices.',
        confidenceScore: 92,
      },
      {
