...
export default function ChatPage() {
  ...
  return (
    <>
      ...
      <div className="mx-auto h-full max-w-screen p-3">
        <div className="space-y-6">
          {/* Header */}
          <div className="rounded-xl bg-gray-100 p-4 shadow dark:bg-gray-900">
          ...
          {/* Chat Box */}
          <div className="flex h-[60vh] max-h-[60vh] flex-col gap-4 overflow-y-auto rounded-xl bg-gray-100 p-4 shadow dark:rounded-none dark:bg-inherit dark:shadow-none">
            <div>
              <ChatCard
          ...
          >
            <input
              ...
              className="flex-1 rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-800 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              value={message}
