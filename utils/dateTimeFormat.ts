 ...
 */
export function formatToMonthDayYear(dateInput: Date | string | number): string {
    let date: Date;
    ...
    try {
        ...
        throw new Error(`Unable to parse date: ${dateInput}. ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
