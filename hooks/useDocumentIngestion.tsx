...
export const useDocumentIngestion = (): UseDocumentIngestionReturn => {
  ...
  const syncDocuments = useCallback(
    async (request: DocumentSyncRequest): Promise<DocumentSyncResponse> => {
      try {
        setLoading(true);
        setError(null);
  ...
  const syncSingleDocument = useCallback(
  ...
  const syncAllDocuments =
    useCallback(async (): Promise<DocumentSyncResponse> => {
      try {
        setLoading(true);
        setError(null);
  ...
  const getDocumentStatus = useCallback(
    async (documentId: string): Promise<DocumentStatusResponse> => {
      try {
        setError(null);
  ...
  const getMultipleStatuses = useCallback(
    async (documentIds: string[]): Promise<DocumentStatusResponse[]> => {
      try {
        setError(null);
  ...
  const getPendingDocuments =
    useCallback(async (): Promise<PendingDocumentsResponse> => {
      try {
        setError(null);
