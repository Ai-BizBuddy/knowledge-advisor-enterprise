...
export const useAdkChat = () => {
  ...
  const updateMessage = useCallback((messageId: string, content: string, isComplete = false) => {
  ...
  const sendMessage = useCallback(async (
    ...
    try {
      ...
      const chatResult = await adkChatService.sendMessageWithStreaming(
        ...
        // Error handler
        (error: string) => {
          updateMessage(aiMessageId, `ขออภัยครับ เกิดข้อผิดพลาด: ${error}`, true);
      ...
      updateMessage(aiMessageId, `ขออภัยครับ เกิดข้อผิดพลาดในการเชื่อมต่อ: ${errorMessage}`, true);
